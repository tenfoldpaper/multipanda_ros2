...
def generate_launch_description():
    ...
    default_scene_xml_file = os.path.join(get_package_share_directory('franka_description'), 'mujoco', 'garmi', 'assets', 'xml', 'garmi.xml')
    ...
    return LaunchDescription([
        ...
        Node( # RVIZ dependency
            ...
            parameters=[
                {'source_list': ['franka/joint_states', 
                                '/left_gripper_sim_node/joint_states',
                                '/right_gripper_sim_node/joint_states'],
                 'rate': 30}],
        ),
        Node(
        ...
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['left_state_broadcaster'],
            output='screen',
        ),
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['right_state_broadcaster'],
            output='screen',
        ),
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['left_model_broadcaster'],
            output='screen',
        ),
        Node(
            package='controller_manager',
            executable='spawner',
            arguments=['right_model_broadcaster'],
            output='screen',
        ),
        Node(
            package='controller_manager',
        ...
        #                "/left/get_robot_states",
        #                "sim_multi_mode_controller",
        #                "panda_joint_impedance_controller",
        #                "/left/panda_joint_impedance_controller/desired_pose"]
        # ),
        # Node(
        #     package="panda_motion_generators",
        #     executable="panda_poly_c2_joint_motion_generator_node",
        #     arguments=["right_joint_via_motion",
        #                "/right/get_robot_states",
        #                "sim_multi_mode_controller",
        #                "panda_joint_impedance_controller",
        #                "/right/panda_joint_impedance_controller/desired_pose"]
        # ),
        Node(package='rviz2',
             executable='rviz2',
             name='rviz2',
