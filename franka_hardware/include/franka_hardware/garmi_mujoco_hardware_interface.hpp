...
#include "franka_hardware/garmi_head_sim.hpp"
...
struct MobileBaseContainer {
  std::string robot_name_;
  std::shared_ptr<MobileBaseSim> base_;
...
struct GarmiHeadContainer {
  std::string robot_name_;
  std::shared_ptr<GarmiHeadSim> head_;
...
class GarmiMujocoHardwareInterface : public hardware_interface::SystemInterface {
 public:
 ...
 private:
  ...
  MobileBaseContainer mobile_base_;
  GarmiHeadContainer garmi_head_;
  ...
  */
  ...
  std::array<double, 7> default_arm_qpos_ = {1.5708, -0.7849355413286309, 0.0005351744148981226, -2.3558839733056853, -0.00042921391383617395, 1.571927056475186, 0.7850445419811712};
