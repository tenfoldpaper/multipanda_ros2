...
class ComlessCoupledDualCartesianImpedanceController :
    public virtual PandaControllerBase<DualCartesianImpedanceControllerParams,
                                       DualCartesianImpedanceControllerPose> {
 public:
  virtual ~ComlessCoupledDualCartesianImpedanceController() = default;
 protected:
  bool bCollisionAvoidance = false;
  bool bManipulability = true;
 private:
